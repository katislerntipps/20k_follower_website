...
function initializeTikTokVideos() {
    const videoPlaceholders = document.querySelectorAll('.tiktok-video-placeholder');
    ...
    videoPlaceholders.forEach(placeholder => {
        placeholder.addEventListener('click', async function() {
            ...
            // Replace placeholder with TikTok embed
            ...
            this.parentElement.appendChild(blockquote);
...
// Initialize TikTok videos on page load
document.addEventListener('DOMContentLoaded', function() {
    initializeTikTokVideos();
});
