...
const lerntipps = [
    ...
    { title: '40-Hz Fokus-Playlist', description: 'Höre 40-Hz-Binaural-Beats beim Lernen. Viele schwören auf den speziellen Takt für mehr Fokus!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '🎧' },
    { title: 'Geschmacks-Anker', description: 'Kaufe beim Lernstart immer denselben Kaugummi (z.B. Zitrone). Dein Gehirn koppelt Geschmack mit Wissen!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '🍬' },
    { title: 'Rückwärts-Challenge', description: 'Lerne oder wiederhole Stoff beim Rückwärtsgehen. Die ungewohnte Bewegung hält dich wach!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '🔙' },
    { title: 'Duft-Trigger', description: 'Nutze ein spezielles Parfüm nur zum Lernen. Gerüche sind starke Erinnerungsauslöser!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '🌸' },
    { title: 'Song-Mode', description: 'Strukturiere den Stoff in Songzeilen und sing ihn durch. Takt + Fakten = Treffer!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '🎶' },
    { title: 'Rap-Coach', description: 'Schreibe einen Lern-Rap und performe ihn laut. Rhythmus speichert Wissen!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '🎤' },
    { title: 'Seitenwechsel', description: 'Schreibe mit der ungewohnten Hand. Neue Nervenbahnen, neues Tempo!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '🖐️' },
    { title: 'Power-Pose-Alarm', description: 'Stelle 2 Minuten Timer und nimm eine Power-Pose ein. Selbstvertrauen vor dem Stoff!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '🦸' },
    { title: 'Kaltstart', description: 'Kaltes Wasser ins Gesicht oder kalte Dusche vor dem Lernen. Kickstart fürs Hirn!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '❄️' },
    { title: 'Upside-Reader', description: 'Lies Texte verkehrt herum oder kopfüber. Kopfstand fürs Denken!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '🙃' },
    { title: 'Juggle-Reminder', description: 'Baue kurze Jonglier-Pausen ein. Mehr Ballgefühl, mehr Synapsen!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '🤹' },
    { title: 'Standing-Mode', description: 'Teste Steh-Sessions oder ein Balanceboard. Bewegung hält den Fokus!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '🧍' },
    { title: 'Farbfilter', description: 'Ordne Themen festen Farben zu und nutze sie konsequent in deinen Notizen. Visuals pushen das Gedächtnis!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '👓' },
    { title: 'Spiegel-Notizen', description: 'Schreibe wichtige Begriffe spiegelverkehrt. Dein Gehirn liebt die Extra-Herausforderung!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '🪞' },
    { title: 'Shorts-Skripte', description: 'Erstelle Skripte für 15-Sekunden-Lernvideos. Kreativ posten = doppelt lernen!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '📱' },
    { title: 'Emotions-Log', description: 'Markiere Fakten mit Emojis und notiere deine Stimmung dazu. Gefühle verankern Wissen!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '❤️' },
    { title: 'Story-Builder', description: 'Spinne absurde Geschichten aus deinem Stoff. Je verrückter, desto einprägsamer!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '📚' },
    { title: 'Nano-Spick', description: 'Schrumpfe deinen Spickzettel Runde für Runde. Am Ende brauchst du ihn nicht mehr!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '📄' },
    { title: 'Rollenwerkstatt', description: 'Erschaffe Charaktere für deine Konzepte. Figuren halten den Stoff lebendig!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '🎭' },
    { title: 'Parcours-Plan', description: 'Lege Lernkarten im Raum fest und geh sie wie einen Parkour ab. Bewegung + Fokus!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '🏃' },
    { title: 'Lernpartner-Dialog', description: 'Erkläre dein Thema einem imaginären 5-Jährigen und stell dir kritische Nachfragen. Dialog = Tiefgang!', category: 'verruckt', subject: 'allgemein', difficulty: 'anfaenger', icon: '🤖' },
